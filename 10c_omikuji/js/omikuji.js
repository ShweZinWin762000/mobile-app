...
const btn1 = document.getElementById("btn1");//const 忘れないで/後btn1=自分で決めるおみくじ　mar btn1 lol pay htar lol ("")contain//
...
btn1.addEventListener("click",
    function () {
        ...
        // omikuji.textContent = resultText[n];
        // omikuji.style.color = resultColor[n];
        // omikuji.style.fontSize = resultFontSize[n];
